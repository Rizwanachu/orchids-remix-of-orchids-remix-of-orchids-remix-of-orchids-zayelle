                    ...
                    <div key={product.id} className="group flex flex-col">
                      ...
                      <div className="mt-3">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <span className="text-[15px] font-semibold text-[#1A1A1A]">Rs. {product.price.toLocaleString("en-IN")}.00</span>
                          {product.compareAt && (
                            <span className="text-[13px] text-[#757575] line-through">Rs. {product.compareAt.toLocaleString("en-IN")}.00</span>
                          )}
                        </div>
                      </div>
                    </div>
